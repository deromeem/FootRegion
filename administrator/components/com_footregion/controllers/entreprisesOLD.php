...
class EgsControllerEntreprises extends EgsController
{
	...
	{
		JRequest::setVar('view', 'entreprise');
	...
	function save()                                 // saves a record and redirect to main page, returns void
	{
		...
		$link = 'index.php?option=com_egs&view=entreprises';
	...
	{
		$this->setRedirect('index.php?option=com_egs&view=entreprises');
		...
		$query = 'UPDATE #__egs_entreprises'
