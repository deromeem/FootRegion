...
class EgsControllerClubs extends EgsController
{
	...
	function save()                                 // saves a record and redirect to main page, returns void
	{
		...
		$link = 'index.php?option=com_egs&view=clubs';
	...
	{
		$this->setRedirect('index.php?option=com_egs&view=clubs');
