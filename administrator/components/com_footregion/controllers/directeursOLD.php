...
class EgsControllerDirecteurs extends EgsController
{
	...
	{
		JRequest::setVar('view', 'directeur');
	...
	function save()                                 // saves a record and redirect to main page, returns void
	{
		...
		$link = 'index.php?option=com_egs&view=directeurs';
	...
	{
		$this->setRedirect('index.php?option=com_egs&view=directeurs');
