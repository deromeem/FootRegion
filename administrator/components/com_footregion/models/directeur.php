...
class FootregionModelDirecteur extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'directeur';
	public $typeAlias = 'com_footregion.directeur';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'directeur', $prefix = 'FootregionTable', $config = array()) 
	{
