...
class FootregionModelStatuts extends JModelList
{
	...
	{
		// récupère les informations de la session statut nécessaires au paramétrage de l'écran
	...
	protected function getListQuery()
	{
		...
		$query->select('s.id, s.statut, s.published, s.hits, s.modified');
		$query->from('#__footregion_statuts s');
