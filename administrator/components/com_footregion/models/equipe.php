...
class FootregionModelEquipe extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'equipe';
	public $typeAlias = 'com_footregion.equipe';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Equipe', $prefix = 'FootregionTable', $config = array()) 
	{
