...
class FootregionModelArbitre extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'Arbitre';
	public $typeAlias = 'com_footregion.Arbitre';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Arbitre', $prefix = 'FootregionTable', $config = array()) 
	{
