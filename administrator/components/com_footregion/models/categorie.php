...
class FootregionModelCategorie extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'categorie';
	public $typeAlias = 'com_footregion.categorie';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'categorie', $prefix = 'FootregionTable', $config = array()) 
	{
