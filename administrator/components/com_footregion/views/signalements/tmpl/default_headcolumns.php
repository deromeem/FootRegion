...
?>
	...
	<tr>
        ...
        <th width="30%">
                <?php echo JHtml::_('grid.sort', 'COM_FOOTREGION_SIGNALEMENTS_ARBITRES_ID', 's.arbitres_id', $listDirn, $listOrder) ?>
        </th>
        <th width="30%" class="nowrap hidden-phone">
                <?php echo JHtml::_('grid.sort', 'COM_FOOTREGION_SIGNALEMENTS_ENTRAINEURS_ID', 's.entraineurs_id', $listDirn, $listOrder) ?>
        </th>
