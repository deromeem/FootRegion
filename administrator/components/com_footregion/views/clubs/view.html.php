...
class FootRegionViewClubs extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		UtilisateurHelper::addSubmenu('clubs');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_FOOTREGION')." : ".JText::_('COM_FOOTREGION_CLUBS'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('club.add');
		JToolBarHelper::editList('club.edit');
		JToolBarHelper::deleteList('Etes vous sur ?', 'clubs.delete');
 	...
 	protected function getSortFields()
	{
		...
		return array(
			'c.nom' => JText::_('COM_FOOTREGION_CLUBS_NOM'),
			'c.id' => "Id"
		);
	}  
