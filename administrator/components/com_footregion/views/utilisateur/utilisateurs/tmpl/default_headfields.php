...
?>
	...
	<div id="filter-bar" class="btn-toolbar">
		<div class="filter-search btn-group pull-left">
			...
			value="<?php echo $this->escape($this->state->get('filter.search')); ?>" class="hasTooltip"  title="Recherche de titre, description de tickets ou date de modification.<br />Recherche rapide d'un ID : 'id:123'" />
		</div>
