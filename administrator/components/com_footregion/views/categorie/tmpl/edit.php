...
<script type="text/javascript">
	...
	{
		if (task == 'categorie.cancel' || document.formvalidator.isValid(document.id('footregion-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_footregion&view=categories&layout=edit&id='.(int) $this->item->id); ?>"
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'details', JText::_('COM_FOOTREGION_CATEGORIE')); ?>
		<div class="row-fluid">
