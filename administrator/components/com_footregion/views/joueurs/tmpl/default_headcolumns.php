...
?>
	...
	<tr>
        ...
        <th width="35%">
                <?php echo JHtml::_('grid.sort', 'COM_FOOTREGION_JOUEURS_ID', 'j.id', $listDirn, $listOrder) ?>
        </th>
        <th>
        ...
        <th class="nowrap center" width="1%" style="min-width:55px">
                <?php echo JHtml::_('grid.sort', 'Publié', 'j.published', $listDirn, $listOrder) ?>
        </th>
        <th class="nowrap center hidden-tablet hidden-phone"  width="1%" style="min-width:120px">
	...
	<th class="nowrap center hidden-tablet hidden-phone" width="1%">
