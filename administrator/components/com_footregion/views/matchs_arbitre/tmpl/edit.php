...
<script type="text/javascript">
	...
	{
		if (task == 'matchs_arbitre.cancel' || document.formvalidator.isValid(document.id('footregion-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_footregion&layout=edit&id='.(int) $this->item->id); ?>"
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'matchs_arbitre')); ?>

	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'matchs_arbitre', JText::_('COM_FOOTREGION_MATCHS_ARBITRE')); ?>
	<div class="row-fluid">
		<div class="span9">
