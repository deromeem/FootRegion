...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_footregion&view=discussion&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="form-inline form-inline-header">
		...
		<div class="btn-group pull-left">
			<a href="<?php echo JRoute::_('index.php?option=com_footregion&view=form_discussion&layout=edit'); ?>" class="btn" role="button"><span class="icon-plus"></span></a>
		</div>	
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_FOOTREGION_DISCUSSIONS_THEME'), 'theme', $listDirn, $listOrder) ?>
				</th>
				<!-- <th class="title">Publié</th> -->
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('Utilisateur'), 'utilisateur_id', $listDirn, $listOrder) ?>
				</th>
			</tr>
		</thead>
