...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_footregion&view=message&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-stripped" id="articleList">
		<thead>
			<tr>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_FOOTREGION_MESSAGES_LIBELLE'), 'libelle', $listDirn, $listOrder) ?>
				</th>
				<!-- <th class="title">Publié</th> -->
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_FOOTREGION_MESSAGES_DISCUSSIONS_ID'), 'discussions_id', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_FOOTREGION_MESSAGES_UTILISATEURS_ID'), 'utilisateurs_id', $listDirn, $listOrder) ?>
				</th>
