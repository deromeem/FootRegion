...
<?php else : ?>
	...
	<script type="text/javascript">
		...
		Joomla.submitbutton = function(task)
		{
			...
			if (task == 'equipe.cancel' || document.formvalidator.isValid(document.getElementById('adminForm')))
			{
		...
		<form action="<?php echo JRoute::_('index.php?option=com_footregion&a_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
			...
			<div class="form-inline form-inline-header">
				<div class="btn-group pull-left">
					...
					<h2><?php echo JText::_('COM_FOOTREGION_EQUIPE')." ".($isNew ? JText::_('COM_FOOTREGION_ADD_PAR'): JText::_('COM_FOOTREGION_MODIF_PAR')); ?></h2>
				</div>
				<div class="btn-toolbar">
					<div class="btn-group pull-right">
						<button type="button" class="btn" onclick="Joomla.submitbutton('equipe.cancel')">
							<span class="icon-cancel"></span>
						</button>
					</div>
					<div class="btn-group pull-right">
						<button type="button" class="btn btn-primary validate" onclick="Joomla.submitbutton('equipe.save')">
			...
			<fieldset>
				<ul class="nav nav-tabs">
					<li><a href="#equipe" data-toggle="tab"><?php echo JText::_('COM_FOOTREGION_EQUIPE'); ?></a></li>
					...
					<div class="tab-pane active" id="equipe">
						<table class="table">
							<tbody>
								...
								<tr>
									<td width="20%" class="nowrap right">
										<div class="control-label"><?php echo $this->form->getLabel('typesequipes_id'); ?></div>
									</td>
									<td width="80%">
										<div class="controls"><?php echo $this->form->getInput('typesequipes_id'); ?></div>
									</td>
								</tr>
								<tr>
									<td width="20%" class="nowrap right">
