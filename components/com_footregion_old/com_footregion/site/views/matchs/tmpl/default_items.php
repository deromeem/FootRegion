	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				...
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_footregion_matchS_PRENOM'), 'prenom', $listDirn, $listOrder) ?>
				</th>
				<!-- <th class="title">Publié</th> -->
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_footregion_matchS_TYPEmatch'), 'typematch', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_footregion_matchS_match'), 'match', $listDirn, $listOrder) ?>
				</th>
