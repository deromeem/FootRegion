...
class FootregionModelSignalement extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'signalement';
	public $typeAlias = 'com_footregion.signalement';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Signalement', $prefix = 'FootregionTable', $config = array()) 
	{
