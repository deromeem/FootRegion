...
class FootregionModelStatut extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'statut';
	public $typeAlias = 'com_footregion.statut';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Statut', $prefix = 'FootregionTable', $config = array()) 
	{
