...
class FootregionModelClub extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'club';
	public $typeAlias = 'com_footregion.club';
	
	// Surcharges des m�thodes de la classe m�re pour :
	
	// 1) d�finir la table de soutien � utiliser
	public function getTable($type = 'club', $prefix = 'FootregionTable', $config = array()) 
	{
