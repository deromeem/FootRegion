...
class FootregionModelUtilisateur extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'utilisateur';
	public $typeAlias = 'com_footregion.utilisateur';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Utilisateur', $prefix = 'FootregionTable', $config = array()) 
	{
