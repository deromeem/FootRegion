...
class FootregionModelEntraineur extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'entraineur';
	public $typeAlias = 'com_footregion.entraineur';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Entraineur', $prefix = 'FootregionTable', $config = array()) 
	{
