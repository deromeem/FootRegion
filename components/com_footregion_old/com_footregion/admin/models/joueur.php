...
class FootregionModelJoueur extends JModelAdmin
{
	protected $_compo = 'com_footregion';
	protected $_context = 'joueur';
	public $typeAlias = 'com_footregion.joueur';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Joueur', $prefix = 'FootregionTable', $config = array()) 
	{
