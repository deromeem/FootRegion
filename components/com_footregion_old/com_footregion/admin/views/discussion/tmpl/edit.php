...
<script type="text/javascript">
	...
	{
		if (task == 'discussion.cancel' || document.formvalidator.isValid(document.id('footregion-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_footregion&layout=edit&id='.(int) $this->item->id); ?>"
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'discussion', JText::_('COM_FOOTREGION_DISCUSSION')); ?>
		<div class="row-fluid">
			<div class="span9">
