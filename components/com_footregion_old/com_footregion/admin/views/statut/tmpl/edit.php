...
<script type="text/javascript">
	...
	{
		if (task == 'statut.cancel' || document.formvalidator.isValid(document.id('footregion-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_footregion&layout=edit&id='.(int) $this->item->id); ?>"
	...
	<div class="form-inline form-inline-header">
		<div class="control-group">
			<div class="control-label"><?php echo $this->form->getLabel('statut'); ?></div>
			<div class="controls"><?php echo $this->form->getInput('statut'); ?></div>
		</div>										
		<div class="control-group">
