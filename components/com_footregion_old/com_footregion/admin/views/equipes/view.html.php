...
class FootregionViewEquipes extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		UtilisateurHelper::addSubmenu('Equipes');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_FOOTREGION')." : ".JText::_('COM_FOOTREGION_EQUIPES'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('equipe.add');
		JToolBarHelper::editList('equipe.edit');
		JToolBarHelper::deleteList('COM_FOOTREGION_DELETE_CONFIRM', 'equipes.delete');
		JToolbarHelper::publish('equipes.publish', 'JTOOLBAR_PUBLISH', true);
		JToolbarHelper::unpublish('equipes.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		JToolbarHelper::archiveList('equipes.archive');
		JToolbarHelper::checkin('equipes.checkin');
		JToolbarHelper::trash('equipes.trash');
 	...
 	protected function getSortFields()
	{
		...
		return array(
			'eq.nom' => JText::_('COM_FOOTREGION_EQUIPES_NOM'),
			'eq.club_id' => JText::_('COM_FOOTREGION_CLUBS'),
			'eq.categories_id' => JText::_('COM_FOOTREGION_CATEGORIES'),
			'eq.entraineurs_id' => JText::_('COM_FOOTREGION_ENTRAINEURS'),
			'eq.published' => JText::_('JSTATUS'),
			'eq.modified' => JText::_('JDATE'),
			'eq.id' => "Id"
		);
	}  
